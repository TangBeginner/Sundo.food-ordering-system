...
<?php
    ...
    function insert_feedback($product_id,$rating,$review){
        $dbname = 'webappdb';
        $tablename = 'feedback';
        $servername = "localhost"; 
        $username = "root"; 
        ...
        $sql = " CREATE TABLE IF NOT EXISTS $tablename
            ...
            $con = mysqli_connect($servername, $username, $password, $dbname);  
            // $query = "INSERT INTO $tablename (product_id, product_name, product_price, product_image, product_detail) VALUES ('$product_id', '$product_name', '$product_price', '$product_image', '$product_detail')";
            $query = "INSERT INTO $tablename (feedback_id,user_id, product_id, rating, review) VALUES ('$feedback_id', '$user_id', '$product_id','$rating','$review')";
            mysqli_query($con, $query);
            echo "
...
<div class="main">  
<div class="box">
<h1 class="top_title">Review</h1> 
<form method="post">
    <h3 class="top_title">Please Select your order</h3>   
    ...
    <h3 class="top_title">Please Rate your order</h3>   
    <div class="small_box">
        <input type="radio" value="Poor" name="rating">
        <label for="rating">Poor</label>
    </div>
    <div class="small_box">
        <input type="radio" value="Below Average" name="rating">
        <label for="rating">Below Average</label>
    </div>
    <div class="small_box">
        <input type="radio" value="Average" name="rating">
        <label for="rating">Average</label>
    </div>
    <div class="small_box">
        <input type="radio" value="Good" name="rating">
        <label for="rating">Good</label>
    </div>
    <div class="small_box">
        <input type="radio" value="Excellent" name="rating">
        <label for="rating">Excellent</label>
    </div>
    <h3 class="top_title">Comments / Suggestions?</h3>   
        ...
        <?php
            ...
            if (($_SERVER['REQUEST_METHOD'] == 'POST')) {
                if (isset($_POST['add'])){
                    ...
                    $rating = $_POST['rating'];
                    $review = $_POST['review'];
                    insert_feedback($product_id,$rating,$review);
